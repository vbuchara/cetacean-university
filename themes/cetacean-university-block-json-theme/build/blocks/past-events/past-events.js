...
/***/ "./src/blocks/past-events/edit.tsx":
/*!*****************************************!*\
  !*** ./src/blocks/past-events/edit.tsx ***!
  \*****************************************/
...
function EditComponent(props) {
  ...
  const pastEvents = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => {
    return select(_wordpress_core_data__WEBPACK_IMPORTED_MODULE_2__.store).getEntityRecords("postType", "event", {
      orderby: "meta_value",
      order: "asc",
      meta_key: "event_date",
      meta_query_key: "event_date",
      meta_query_value: (0,date_fns__WEBPACK_IMPORTED_MODULE_6__.format)(dateNow, "yyyyMMddHHmmss"),
      meta_query_compare: "<",
      meta_query_type: "DATE"
    });
  }, []);
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_editor_wrapper__WEBPACK_IMPORTED_MODULE_5__.EditorWrapper, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "container container--narrow page-section"
  }, !pastEvents ? "" : pastEvents.map(event => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_event__WEBPACK_IMPORTED_MODULE_4__.Event, {
    key: event.id,
    event: event,
    isOnEditor: true
  })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("hr", {
    className: "section-break"
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_editor_anchor__WEBPACK_IMPORTED_MODULE_1__.EditorAnchor, null, "See Upcoming Events"))));
}

/***/ }),

/***/ "./src/blocks/past-events/past-events.tsx":
/*!************************************************!*\
  !*** ./src/blocks/past-events/past-events.tsx ***!
  \************************************************/
...
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./edit */ "./src/blocks/past-events/edit.tsx");


const block = (await __webpack_require__.e(/*! import() */ "src_blocks_past-events_block_json").then(__webpack_require__.t.bind(__webpack_require__, /*! ./block.json */ "./src/blocks/past-events/block.json", 19))).default;
...
/******/ 		var installedChunks = {
/******/ 			"blocks/past-events/past-events": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors"], () => (__webpack_require__("./src/blocks/past-events/past-events.tsx")))
