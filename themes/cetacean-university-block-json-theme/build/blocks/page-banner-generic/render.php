<?php
    ...
    $pageBannerImageFromId = isset($attributes['bannerImageId']) 
        ? wp_get_attachment_image_src($attributes['bannerImageId'], "page-banner")
        : [];
    $sourceBannerImageFromId = isset($attributes['bannerImageId'])
        ? wp_get_attachment_image_src($attributes['bannerImageId'], "full")
        : [];
    $defaultBannerImage = !isset($attributes['bannerImageId']) | empty($attributes['bannerImageId'])
        ? get_theme_file_uri("/images/ocean.jpg")
        : (isset($pageBannerImageFromId[0]) ? $pageBannerImageFromId[0] : $sourceBannerImageFromId[0]);
