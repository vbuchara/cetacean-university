...
class LiveSearch {
  ...
  */
  onSearchInput(event) {
    ...
    ;
    this.searchTimeout = setTimeout(() => this.getSearchResults(event), 500);
  }
...
class MyNotes {
  ...
  async createNote(event) {
    try {
      ...
      const newTitleFieldInput = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<input>').appendTo(newNoteItem).addClass('note-title-field').val(response.title.raw).attr('readonly', 'true');
      ...
      const newContentFieldTextarea = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<textarea>').appendTo(newNoteItem).addClass('note-body-field').attr('readonly', 'true').text(response.content.raw);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkcetacean_university_theme"] = globalThis["webpackChunkcetacean_university_theme"] || [];
